 ...
 */
public class Starters_Veg extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] starters = {"Paneer Tikka","Achari Paneer Tikka","Haryali Paneer Tikka","Paneer Malai Tikka","Malai Chaap","Achari Chaap","Stuffed Chaap","Tandoori Chaap","Lasuni Paneer Tikka","Mushroom Tikka"};
        Integer[] price = {160,175,165,180,175,160,180,160,170,180};
