 ...
 */
public class Raita_and_Salad extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] raita_salad = {"Green Salad","Boondi Raita","Mix Veg Raita","Pineapple Raita"};
        Integer[] price = {50,60,70,90};
