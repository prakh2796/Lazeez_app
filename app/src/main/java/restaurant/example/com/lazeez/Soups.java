...
public class Soups extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] soups = {"Tomato Soup","Veg Manchow Soup","Veg Hot N Sour Soup","Non-Veg Manchow Soup","Non-Veg Hot N Sour Soup"};
        Integer[] price = {100,110,110,120,130};
